...
?>
      ...
      <div class="portfolio">
        <div class="fl_left">
          ...
          <p>This vertical bar chart diplays the most successful break-ins per day (Top 20) for the particular honeypot system. The numbers indicate how many times correct credentials were given by attackers.</p>
			<p><a href="export.php?type=SuccessLogon">CSV Of All Successfull Logons</a><p>
		  </div>
		...
		<div class="fl_left">
          <p>This line chart diplays the daily successes on the honeypot system. Spikes indicate successful entries over a weekly period.<br/><br/><strong>Warning:</strong> Dates with zero successes are not displayed.</p>
			<p><a href="export.php?type=SuccessDay">CSV Of All daily Success</a><p>
		</div>
		...
		<div class="fl_left">
		  ...
		  <p><a href="export.php?type=SuccessWeek">CSV Of All Weekly Success</a><p>
        </div>
      ...
      <div class="portfolio">
        <div class="fl_left">
		  ...
		  <p><a href="export.php?type=SuccessIP">CSV Of All daily Success</a><p>
        </div>
      ...
      <div class="portfolio">
        <div class="fl_left">
		  ...
		  <p><a href="export.php?type=SuccessIP">CSV Of All Successful IP's</a><p>
        </div>
